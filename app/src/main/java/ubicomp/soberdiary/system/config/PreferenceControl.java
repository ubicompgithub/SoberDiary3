...
public class PreferenceControl {
	...
	public static String[] getRecreations() {
		...
		recreation[0] = sp.getString("recreation0", App.getContext().getString(R.string.default_recreation_1));
		recreation[1] = sp.getString("recreation1", App.getContext().getString(R.string.default_recreation_2));
		recreation[2] = sp.getString("recreation2", App.getContext().getString(R.string.default_recreation_3));
	...
	public static String getSavingGoal() {
		return sp.getString("targetGood", App.getContext().getString(R.string.default_goal_good));
	}
	...
	public static int getTotalCounter() {
		...
		int total_counter = db.getLatestDetection().getScore() + db.getLatestEmotionDIY().getScore()
				+ db.getLatestEmotionManagement().getScore() + db.getLatestQuestionnaire().getScore()
				+ +db.getLatestStorytellingTest().getScore() + +db.getLatestUserVoiceRecord().getScore()
				+ +db.getLatestStorytellingRead().getScore() + +db.getLatestFacebookInfo().getScore()
