...
import ubicomp.soberdiary.statistic.data.UserLevelCollector;
...
public class AnalysisRankView extends StatisticPageView {
	...
	public AnalysisRankView(ShowRadarChart showRadarChart) {
		...
		helpStr = context.getResources().getStringArray(R.array.analysis_rank_change_help);
		...
		changeMonth = (TextView) view.findViewById(R.id.analysis_rank_help_month_text);
		changeMonth.setTypeface(wordTypeface);
		changeWeek = (TextView) view.findViewById(R.id.analysis_rank_help_week_text);
		changeWeek.setTypeface(wordTypeface);
		
		pointerMonth  = (ImageView) view.findViewById(R.id.analysis_rank_pointer_month);
		paramMonth = (LayoutParams) pointerMonth.getLayoutParams();
		pointerWeek  = (ImageView) view.findViewById(R.id.analysis_rank_pointer_week);
		...
		contentLayoutMonth = (RelativeLayout) view.findViewById(R.id.analysis_rank_content_layout_month);
		
		contentLayoutWeek = (RelativeLayout) view.findViewById(R.id.analysis_rank_content_layout_week);
		
		decreaseMonth = (ImageView) view.findViewById(R.id.analysis_rank_decrease_month);
		decreaseMonth.setVisibility(View.INVISIBLE);
		increaseMonth = (ImageView) view.findViewById(R.id.analysis_rank_increase_month);
		increaseMonth.setVisibility(View.INVISIBLE);
		decreaseWeek = (ImageView) view.findViewById(R.id.analysis_rank_decrease_week);
		decreaseWeek.setVisibility(View.INVISIBLE);
		increaseWeek = (ImageView) view.findViewById(R.id.analysis_rank_increase_week);
		increaseWeek.setVisibility(View.INVISIBLE);
		
		titleLayout = (RelativeLayout) view.findViewById(R.id.analysis_rank_title_layout);
	}
