...
public class BootBoardcastReceiver extends BroadcastReceiver {
	...
	public static void setRegularNotification(Context context, Intent intent) {
		...
		PendingIntent pending = PendingIntent.getBroadcast(context, requestCodeRegularNotification, service_intent,
	...
	public static void setRegularCheck(Context context, Intent intent) {
		...
		PendingIntent pending2 = PendingIntent.getBroadcast(context, requestCodeRegularCheck, check_intent,
				PendingIntent.FLAG_CANCEL_CURRENT);
		alarm.cancel(pending2);
		alarm.setInexactRepeating(AlarmManager.RTC_WAKEUP, System.currentTimeMillis() + 10000,
