...
public class Rank {
	...
	public String toString() {
		...
		sb.append(uid + " " + score + "\n");
		sb.append("test<" + test + ">\n");
		sb.append("advice<" + advice + "," + adviceQuestionnaire + "," + adviceEmotionDiy + ">\n");
		sb.append("manage<" + manage + "," + manageVoice + ',' + manageEmotion + "," + manageAdditional + ">\n");
		sb.append("story<" + story + "," + storyRead + "," + storyTest + "," + storyFb + ">\n");
		return sb.toString();
	}
